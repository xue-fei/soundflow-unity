...
namespace SoundFlow.Experimental
{
    ...
    public class VoiceActivityEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VoiceActivityEventArgs"/> class.
        /// </summary>
        /// <param name="isActive">Whether voice activity is currently active.</param>
        /// <param name="energy">The current energy level of the audio signal.</param>
        /// <param name="noise">The current noise floor level.</param>
        /// <param name="confidence">The confidence level of voice activity detection.</param>
        public VoiceActivityEventArgs(bool isActive, float energy, float noise, float confidence)
        {
            IsActive = isActive;
