...
namespace SoundFlow.Components
{
    ...
    public sealed class Mixer : SoundComponent, IDisposable
    {
        ...
        private readonly ConcurrentDictionary<SoundComponent, byte> _components = new ConcurrentDictionary<SoundComponent, byte>();
        ...
        /// </summary>
        public static Mixer Master { get; } = new Mixer();
