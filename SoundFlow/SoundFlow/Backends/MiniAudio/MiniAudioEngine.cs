...
namespace SoundFlow.Backends.MiniAudio
{
    ...
    public sealed class MiniAudioEngine : AudioEngine
    {
        ...
        private IntPtr _currentPlaybackDeviceId = IntPtr.Zero;
        private IntPtr _currentCaptureDeviceId = IntPtr.Zero;
        ...
        private void InitializeDeviceInternal(IntPtr playbackDeviceId, IntPtr captureDeviceId)
        {
        ...
        public override void UpdateDevicesInfo()
        {
            ...
            if (playbackDeviceCount == IntPtr.Zero) PlaybackDevices = new DeviceInfo[] { };
            if (captureDeviceCount == IntPtr.Zero) CaptureDevices = new DeviceInfo[] { };
        }
    }
}